...
- [Core selection patterns](#core-selection-patterns)
...
<LiveExample
  html={String.raw`  <select class="selectpicker" data-selection-indicator="checkbox">
...
<LiveExample
  html={String.raw`  <select class="selectpicker" multiple data-selection-indicator="checkbox" placeholder="Choose frameworks">
