...
</div>`}),"\n",(0,s.jsx)(t.pre,{children:(0,s.jsx)(t.code,{className:"language-html",children:'<select class="selectpicker">\n  <option>Mustard</option>\n  <option>Ketchup</option>\n  <option>Relish</option>\n</select>\n'})}),"\n",(0,s.jsx)("span",{id:"optgroup"}),"\n",(0,s.jsx)(t.h2,{id:"select-boxes-with-optgroups",children:"Select boxes with optgroups"}),"\n",(0,s.jsx)(l.A,{html:String.raw`  <select class="selectpicker">
...
</select>`}),"\n",(0,s.jsx)(t.pre,{children:(0,s.jsx)(t.code,{className:"language-html",children:'<select class="selectpicker">\n  <optgroup label="Picnic">\n    <option>Mustard</option>\n    <option>Ketchup</option>\n    <option>Relish</option>\n  </optgroup>\n  <optgroup label="Camping">\n    <option>Tent</option>\n    <option>Flashlight</option>\n    <option>Toilet Paper</option>\n  </optgroup>\n</select>\n'})}),"\n",(0,s.jsx)(t.h2,{id:"multiple-select-boxes",children:"Multiple select boxes"}),"\n",(0,s.jsx)(l.A,{html:String.raw`  <select class="selectpicker" multiple>
  <option>Mustard</option>
  <option>Ketchup</option>
  <option>Relish</option>
</select>`}),"\n",(0,s.jsx)(t.pre,{children:(0,s.jsx)(t.code,{className:"language-html",children:'<select class="selectpicker" multiple>\n  <option>Mustard</option>\n  <option>Ketchup</option>\n  <option>Relish</option>\n</select>\n'})}),"\n",(0,s.jsx)(t.h2,{id:"live-search",children:"Live search"}),"\n",(0,s.jsxs)(t.p,{children:["You can add a search input by passing ",(0,s.jsx)(t.code,{children:'data-live-search="true"'})," attribute:"]}),"\n",(0,s.jsx)(l.A,{html:String.raw`  <select class="selectpicker" data-live-search="true">
